<x-account-layout>
    ...
    <table class="w-full table-auto border-collapse rounded-md">
        <tr>
            <th class="bg-[#5D6749] lg:text-base text-3xl text-white px-4 py-2 text-center">ID</th>
            ...
            <th class="bg-[#5D6749] lg:text-base text-3xl text-white px-4 py-2 text-center"></th>
        </tr>
