<x-account-layout>
    ...
    <div class="flex  flex-col justify-center items-stretch gap-4 lg:flex-row">
       
        <div class="flex basis-[60%] flex-col bg-[#FCF9F4] shadow-md px-10 py-10 lg:px-5 justify-center rounded-[50px] items-center">
        ...
        <div class="flex h-full flex-col basis-[40%] shadow-md w-full bg-[#FCF9F4] py-10 p-5 justify-center rounded-[50px] items-center">
            <p class="text-4xl font-bold text-[#FFC815] mb-5 text-center">Personal Info</p>
            <div class="flex flex-col space-y-4">
                <div class="flex w-full bg-green-400 shadow-md rounded-md p-10 lg:p-5 items-center">
                    <p class="text-white text-3xl lg:text-xl">Name</p>
                    <p class="text-white text-5xl lg:text-2xl font-medium ml-5">{{ $info ->name }}</p>
                </div>
                <div class="flex w-full  bg-green-400 shadow-md rounded-md p-10 lg:p-5 items-center">
                    <p class="text-white text-3xl lg:text-xl">Status</p> 
                    <p class="text-white text-5xl lg:text-2xl font-medium ml-5">{{ $info ->status }}</p>
    
                </div>
                <div class="flex w-full bg-green-400 shadow-md rounded-md p-10 lg:p-5 items-center">
                    <p class="text-white text-3xl lg:text-xl">Contact</p> 
                    <p class="text-white text-4xl lg:text-xl font-medium ml-5">{{ $info ->contact }}</p>
