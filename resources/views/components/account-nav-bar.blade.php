<div class="flex flex-col lg:h-screen lg:basis-[20%] bg-[#505E00] text-white">
    <div class="p-5 bg-[#3E4C00] flex items-center justify-between lg:justify-center">
        <span class="text-xl font-bold tracking-wide uppercase">Admin Panel</span>
