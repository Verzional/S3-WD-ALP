...
<div class="flex lg:fixed flex-col lg:h-screen lg:basis-[20%] lg:w-[20vw] bg-[#262515] z-10 text-white">
    <div class="p-5 bg-[#5D6749] flex items-center justify-between lg:justify-center">
        <span class="text-3xl lg:text-xl font-bold tracking-wide uppercase">
        ...
        <button id="burgerMenu" class="lg:hidden p-2 rounded-md hover:bg-[#687B00] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-24 h-24 lg:h-6 lg:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <nav
        ...
        <a href="/logout" class="flex items-center p-3 text-3xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <nav
        ...
        <a href="/student/detailUser" class="{{ request()->is('student/detailUser') ? 'text-[#FFC815]' : 'text-white'}} flex items-center p-5 lg:p-3 text-5xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg class="{{ request()->is('student/detailUser') ? 'fill-[#FFC815]' : 'fill-white'}} h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.671 60.671" xml:space="preserve" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <ellipse style="" cx="30.336" cy="12.097" rx="11.997" ry="12.097"></ellipse> <path style="" d="M35.64,30.079H25.031c-7.021,0-12.714,5.739-12.714,12.821v17.771h36.037V42.9 C48.354,35.818,42.661,30.079,35.64,30.079z"></path> </g> </g> </g></svg>
            User
        </a>
        <a href="/student/logout" class="flex items-center p-5 lg:p-3 text-3xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m0 0l3-3m-3 3l3 3m4-9h1.5A1.5 1.5 0 0119.5 9v6a1.5 1.5 0 01-1.5 1.5H16m4-6V9m0 6v3.5a1.5 1.5 0 01-1.5 1.5H8.5" />
            </svg>
            Exit
    ...
    <nav
        ...
        <a href="/companion/participants" class="{{ request()->is('companion/participants') ? 'text-[#FFC815]' : 'text-white'}}  flex items-center p-5 lg:p-3 text-5xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5V10M12 20H7a2 2 0 01-2-2V4a2 2 0 012-2h10a2 2 0 012 2v4m0 0H7" />
            </svg>
            Participants
        </a>
        <a href="/companion/user" class="{{ request()->is('companion/user') ? 'text-[#FFC815]' : 'text-white'}} flex items-center p-5 lg:p-3 text-5xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg class="{{ request()->is('companion/user') ? 'fill-[#FFC815]' : 'fill-white'}} h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.671 60.671" xml:space="preserve" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <ellipse style="" cx="30.336" cy="12.097" rx="11.997" ry="12.097"></ellipse> <path style="" d="M35.64,30.079H25.031c-7.021,0-12.714,5.739-12.714,12.821v17.771h36.037V42.9 C48.354,35.818,42.661,30.079,35.64,30.079z"></path> </g> </g> </g></svg>
            User
        </a>
        <a href="/companion/logout" class="flex items-center p-5 lg:p-3 text-5xl lg:text-base rounded-lg hover:bg-[#687B00] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 lg:h-5 lg:w-5 mr-5 lg:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m0 0l3-3m-3 3l3 3m4-9h1.5A1.5 1.5 0 0119.5 9v6a1.5 1.5 0 01-1.5 1.5H16m4-6V9m0 6v3.5a1.5 1.5 0 01-1.5 1.5H8.5" />
            </svg>
            Exit
